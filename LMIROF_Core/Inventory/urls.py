...
urlpatterns = [
    ...
    path('api/inventory/resume/', ListAllProductsInventory.as_view()),
    ...
    #     path('api/inventory/filter/', FilterProduct.as_view()),
    path('api/inventory/<int:product_id>/',GetStockByProductId.as_view()),
]
